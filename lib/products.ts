...
export const products: Product[] = [
  ...
  },
  {
    ...
    colors: ['Natural', 'Brown'],
    sizes: ['Medium', 'Large'],
    image: '/images/categories/gift-bag-1.webp',
  ...
  },
  {
    ...
    colors: ['Natural', 'Brown'],
    sizes: ['Medium', 'Large'],
    image: '/images/categories/jutebag-2.webp',
    description: 'Eco-friendly jute shopping bags for daily use',
  },
  {
    id: 'jsb-002',
    ...
    colors: ['Natural', 'Brown', 'Black'],
    sizes: ['Large'],
    image: '/images/categories/jutebag-3.webp',
    description: 'Premium quality shopping bags with reinforced handles',
  },
  {
    id: 'jtb-001',
...
export const categories = [
  ...
  { id: 'tamboolam-bags', name: 'Tamboolam Wedding Bags' },
